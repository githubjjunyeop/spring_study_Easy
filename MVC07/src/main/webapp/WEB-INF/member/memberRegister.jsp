...
<div class="container">
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
		 ...
		 <form id="form1" name="form1" class="form-horizontal" method="post">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="age" name="age" placeholder="나이 입력" style=" width:10%">
		    </div>
		  </div>
    ...
    <c:if test="${sessionScope.userId != null && sessionScope.userId != '' }">
    <input type="button" value="등록" onclick="add()" class="btn btn-primary" disabled="disabled">
    </c:if>
    
    
    <input type="button" value="취소" onclick="frmreset()" class="btn btn-warning">
